...
- Optional folder preset for creating a `10_...`, `20_...`, `30_...` classification structure under `Web Clips`.
...
- Classification folder preset: Creates a `10_...`, `20_...`, `30_...` folder structure under `Web Clips`.
...
- 分類フォルダプリセット: `Web Clips` 配下に `10_...`, `20_...`, `30_...` の分類フォルダ構成を作成
